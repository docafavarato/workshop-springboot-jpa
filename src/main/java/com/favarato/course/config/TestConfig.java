...
import com.favarato.course.entities.OrderItem;
...
import com.favarato.course.repositories.OrderItemRepository;
import com.favarato.course.repositories.OrderRepository;
import com.favarato.course.repositories.PaymentRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p4 = new Product(null, "PC Gamer", "Donec aliquet odio ac rhoncus cursus.", 1200.0, "/gamingpc.png");
		...
		User u1 = new User(null, "Maria Brown", "maria@gmail.com", "988888888", "123456", UserType.STANDART);
		User u2 = new User(null, "Alex Green", "alex@gmail.com", "977777777", "123456", UserType.PREMIUM);
		User u3 = new User(null, "Charles Red", "charles@gmail.com", "959203565", "charles123", UserType.STANDART);
		...
		Payment pa1 = new Payment(null, Instant.parse("2019-06-20T19:53:07Z"), o2);
		
		paymentRepository.saveAll(Arrays.asList(pa1));
		orderRepository.saveAll(Arrays.asList(o1, o2, o3));
	}
}